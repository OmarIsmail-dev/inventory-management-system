                    ...
                    <div class="table-responsive"> 
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                @if ( $SupplierOrder->status !== "refused" && $SupplierOrder->status !== "pending" && $users )
                                    ...
                                    <tr>
                                           ...
                                           <h5>{{ $product->title}}</h5> 
                                            ...
                                            <td class="text-center">
                                                @if ($SupplierOrder->status == 'Waiting')
                                                    <span class="label label-warning" style="font-size: 13px;">
                                                        {{ $SupplierOrder->status }} </span>
                                                @elseif($SupplierOrder->status == 'completed')
